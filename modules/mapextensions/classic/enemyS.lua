...
function M.new( instance )
	...
	local imageOutline = graphics.newOutline( 2, "images/maps/" .. color .. "/cactusSmall1.png" )
	...
	local function enterFrame(event)
		-- move the instance "enemyL" to right, based on dino.first and dino.jumping propertie
	...
	instance.name = "enemyS"
	instance.type = "enemyS"
	return instance
end
