...
function M.new( instance )
	...
	-- function to call the second enemy in game2.lua
	local function callGameEnemies2()
		scene:spawnEnemies2()
	end

	-- change tag value to move enemy towards dino
	...
	local function enterFrame(event)
		...
		if instance then
			...
			-- move the objects off out the left side of screen to the right side off the screen
